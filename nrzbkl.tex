\documentclass[a4paper,twoside]{article}%[fleqn] kan vara snyggt
\usepackage{custom}
...
För \smash{$\mRe{s} \geq 1$} definieras Riemanns Zeta-funktion som $\sum\limits_{n = 1}^\infty \frac 1 {n^s}$. 
